...
from models.encoders.transformer.layers import EncoderLayer
# from models.encoders import register
...
# def transformer(bn_args=dict()):
#   return TransformerEncoder(d_model=D_MODEL,
#                             d_hidden=D_HIDDEN,
#                             n_layers=N_LAYERS, n_head=N_HEAD,
#                             d_k=D_K,
#                             d_v=D_V, n_position=N_POSITION)
